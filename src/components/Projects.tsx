...
const projects = [
  ...
  { name: "Orbitron", link: "https://github.com/san5kriti", tech: "Space Tech / JS", description: "A web app for stargazing & orbital tracking.", status: "🔭 Researching", image: "/orbitron.png" },
